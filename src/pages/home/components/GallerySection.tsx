...
const spaces = [
  {
    ...
    description: 'Espacios amplios y luminosos diseñados para tu comodidad',
  ...
  },
  {
    ...
    description: 'Cocinas modernas con electrodomésticos de alta gama',
  ...
  },
  {
    ...
    description: 'Dormitorios diseñados para tu descanso perfecto',
